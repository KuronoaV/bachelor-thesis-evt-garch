...
# Backtest library: Kupiec UC (3.6.2), Christoffersen Independence and CC
# (3.6.3, 3.6.4), Acerbi-Szekely Z2 (3.6.5), Basel traffic-light (3.6.6),
# and the Monte Carlo bootstrap p-values (Section 4.6). Sourced; nothing
# executes here.
...
# Z2 <= -1.8 = red. Thresholds match the ones cited in Section 3.6.5.
